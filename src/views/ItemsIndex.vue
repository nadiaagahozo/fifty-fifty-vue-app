        ...
        <div id="main">
          <div class="inner">
            ...
            <section class="tiles">
              ...
              <article v-for="item in items" class="style5">
                <span class="image fit">
                  <img v-bind:src="`${item.images}`" v-bind:alt="item.listing" width="200" height="300" />
                </span>
